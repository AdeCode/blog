              ...
              <div class="row">
                <div class="col-md-6">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="subtitle" value="{{$post->subtitle}}"name="subtitle" placeholder="Enter Post subtitle">
                  </div>
                  <div class="form-group">
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="card card-outline card-info">
                  ...
                  <!-- /.card-header -->
                  <div class="card-body">
                    <textarea id="summernote" name="body" value="{{$post->body}}" style="height: 400px;">
                        {{$post->body}}
                    </textarea>
                  </div>
